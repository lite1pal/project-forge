...
- business rules: `apps/api/src/modules/generated/todo/service.ts`
- persistence queries: `apps/api/src/modules/generated/todo/postgres-repo.ts`
- request validation and route shaping: `apps/api/src/modules/generated/todo/routes.ts`
- UI copy and layout: `apps/web/src/features/todo/components/*`
